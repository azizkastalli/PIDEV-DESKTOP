...
private String address;
    ...
    public User(int id, String confirmation_token, String email, String email_canonical, int enabled, Date last_login, String nom, String password, Date password_requested_at, String prenom, int prix_unitaire, String roles, String salt, String username, String username_canonical, String num_tel, String address) {
        this.id = id;
        this.confirmation_token = confirmation_token;
        this.email = email;
        this.email_canonical = email_canonical;
